...
interface Row { numero: string; cliente: string; estado: string; tecnico: string; fechaIngreso: string; diagnostico: string | null; }
...
export default function Page() {
  ...
  return (
    <InformeLayout titulo="Órdenes con Diagnóstico sin Presupuesto">
