...
export default function Page() {
  ...
  return (
    <InformeLayout titulo="Valorización de Stock">
      <div className="flex gap-3 items-end no-print mb-2">
      ...
      {buscado && (
        <>
          <div className="flex gap-6 text-sm mb-2 font-semibold no-print">
          ...
          <div className="border rounded overflow-hidden text-xs overflow-x-auto">
            ...
            <div className="grid grid-cols-7 px-3 py-2 border-t bg-gray-100 font-bold min-w-[700px]">
              <div className="col-span-5">TOTAL</div><div className="text-right">{formatCurrency(totales.venta)}</div><div />
            </div>
          </div>
        </>
      )}
