            ...
            <CardContent className="space-y-3">
              ...
              <div className="grid grid-cols-2 gap-2">
                <div className="space-y-1">
                  ...
                  <Input value={editForm.numeroParte ?? ""} onChange={e => setEditForm({...editForm, numeroParte: e.target.value})} />
                </div>
                <div className="space-y-1">
              ...
              <div className="space-y-1">
                ...
                <Select value={editForm.categoriaId ?? ""} onValueChange={v => setEditForm({...editForm, categoriaId: v === "none" ? "" : (v ?? "")})}>
                  <SelectTrigger>
              ...
              <div className="grid grid-cols-3 gap-2">
                <div className="space-y-1">
                  ...
                  <Input type="number" min={0} value={editForm.stockMinimo ?? 0} onChange={e => setEditForm({...editForm, stockMinimo: Number(e.target.value)})} />
                </div>
                <div className="space-y-1">
                  <Label>Precio Costo</Label>
                  <Input type="number" min={0} step="0.01" value={editForm.precioCosto ?? 0} onChange={e => setEditForm({...editForm, precioCosto: Number(e.target.value)})} />
                </div>
                <div className="space-y-1">
                  <Label>Precio Venta</Label>
                  <Input type="number" min={0} step="0.01" value={editForm.precioVenta ?? 0} onChange={e => setEditForm({...editForm, precioVenta: Number(e.target.value)})} />
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                ...
                <Dialog open={compatOpen} onOpenChange={setCompatOpen}>
                  <Button size="sm" variant="outline" onClick={() => setCompatOpen(true)}><Plus className="h-3 w-3 mr-1" />Agregar</Button>
                  <DialogContent>
            ...
            <CardHeader>
              <CardTitle className="text-base flex items-center justify-between">
                ...
                <Dialog open={movOpen} onOpenChange={setMovOpen}>
                  <Button size="sm" variant="outline" onClick={() => setMovOpen(true)}><Plus className="h-3 w-3 mr-1" />Movimiento</Button>
                  <DialogContent>
