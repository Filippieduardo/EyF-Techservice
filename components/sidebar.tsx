    ...
    <div className="flex flex-col h-full text-white" style={{ background: "oklch(0.38 0.14 292)" }}>
      ...
      <nav className="flex-1 py-2 overflow-y-auto">
        <div className="px-3 py-1">
          <p className="text-xs font-semibold uppercase px-2" style={{ color: "oklch(0.75 0.06 292)" }}>
            Módulos
          </p>
          <p className="text-xs px-2 mb-1 font-medium" style={{ color: "oklch(0.88 0.08 292)" }}>
            {role === "ADMIN" ? "Administración" : "Técnico"}
          </p>
        </div>
  ...
  return (
    <>
      ...
      <div className="md:hidden fixed top-0 left-0 right-0 z-40 flex items-center gap-3 px-4 py-2 border-b"
        ...
        <button onClick={() => setMobileOpen(true)} className="text-white p-1 rounded" aria-label="Abrir menú">
